import { shallowRef, ref, getCurrentInstance, openBlock, createElementBlock, normalizeStyle, toDisplayString } from "vue";
...
const pages = [
  ...
  {
    path: "components/icon/index/index",
    style: {
  ...
  {
    path: "components/modal/index/index",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "components/calculator/calculator",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
...
const S = false, b = "app", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = b;
I("");
const C = I('[{"provider":"aliyun","spaceName":"ddd","spaceId":"mp-c7fe8bce-ad43-4063-a6e9-56182ea29773","clientSecret":"C1bi2lIFKqrhCQdsTTnMFQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__AFF6350";
} catch (e2) {
...
function Kn(e2) {
  ...
  e2.callFunction = function(t3) {
    ...
    let o2, a2;
    if (t3.data = t3.data || {}, o2 = n2, o2 = o2.bind(e2), Mn(t3))
      a2 = n2.call(e2, t3);
    else if (Dn(t3)) {
...
let Bs = new class {
  init(e2) {
    ...
    t2 = n2.init(e2), js(t2), Kn(t2), function(e3) {
