...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "141606b7-3-" + i0 + "-" + i1 + "," + ("141606b7-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "141606b7-2-" + i0 + "-" + i1 + "," + ("141606b7-1-" + i0)
          };
        }),
        b: "141606b7-1-" + i0 + ",141606b7-0",
        c: "141606b7-4-" + i0 + ",141606b7-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "141606b7-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/dwp/Documents/HBuilderProjects/ddd/pages/ucenter/read-news-log/read-news-log.vue"]]);
